...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.dialog = QtWidgets.QFileDialog(MainForm)
        self.dialog.setObjectName("FileDialog")
        ...
        self.actionOpen.triggered.connect(self.loadDialog)
    ...
    def loadDialog(self):
        self.Canvas.data = self.dialog.getOpenFileName()[0]
        self.Canvas.input()
